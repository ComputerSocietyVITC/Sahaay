    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Department', models.CharField(blank=True, choices=[['ADM', 'Administrator'], ['MGM', 'Management'], ['DPMT', 'Department']], default='Admin', max_length=200)),
                ...
                ('Comments', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Logic.commentstable')),
                ('LinkedIssue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Logic.issues')),
